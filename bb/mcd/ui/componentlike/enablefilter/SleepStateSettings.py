...
class SleepStateSettings(PropertyGroup):
    ...
    setInitialSleepState : EnumProperty(
        ...
        get=lambda self : CLU.getIntFromKey(self.Append("_set_initial_sleep_state")),
        set=lambda self, value : CLU.setValueAtKey(self.Append("_set_initial_sleep_state"), value)
    )
